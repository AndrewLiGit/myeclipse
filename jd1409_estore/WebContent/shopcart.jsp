...
<!--文件体开始-->
		...
		<tr>
			...
			<td class=tablebody2 valign=middle width="">&nbsp;&nbsp;<a href="ProductDetailServlet?productid=${orderline.product.productid }">${orderline.product.name }</a></td>
			<td class=tablebody2 valign=middle align=center width="">${orderline.product.baseprice }</td>
			<td class=tablebody2 valign=middle align=center width=""><input type="text" name="num" value="${orderline.amount }" size="4" onblur="javascript:if(this.value<1){alert('对不起，产品数量不能小于 1 ');this.focus();}else{number.value=this.value;}"/></td>
			<td class=tablebody2 valign=middle align=center width="">&nbsp;&nbsp;${(orderline.product.baseprice)*(orderline.amount) }</td>
			<td class=tablebody2 valign=middle align=center width="">
			<input type="button" value="删除" onclick="javascript:window.location='RemoveProductServlet?productid=${orderline.product.productid }';"> 
		...
		<tr>
			...
			<input type="button" value="清空购物车" onclick="javascript:window.location='ClearCartServlet?orderlines=${orderlines}';"></td>
		</tr>
                </table><br>
<!--文件尾开始-->
		...
		<table width="100%" border="0" cellspacing="0" cellpadding="0" align="center">
		  <tr>
			...
			<p align="center">Copyright &copy;2015 - 2025 <a href="http://www.briup.com.cn"><b><font face="Verdana,">briup</font></b><font color=#CC0000>.com.cn</font></b></a><br>
			</td>
		  </tr>
		</table>
	</body>
