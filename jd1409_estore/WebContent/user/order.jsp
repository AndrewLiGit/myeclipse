...
<!--文件体开始-->
		...
		<tr>
			...
			<input type="button" value="删除" onclick="javascript:window.location='RemoveOrderServlet?orderid=${order.orderid }';">&nbsp;
			<input type="button" value="明细" onclick="javascript:window.location='OrderDetailServlet?orderid=${order.orderid }';"><!--&nbsp;<input type="button" value="修改"/>--> </td>
		</tr>
         </c:forEach>       
