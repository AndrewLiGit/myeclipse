...
<!--文件体开始-->
		...
		<tr>
			...
			<td width="60%" class="tablebody2">${sessionScope.user.userid }</td>
		</tr>
		<tr>
			<td class="tablebody2" align="right"><b>联系地址</b>：</td>
			<td class="tablebody2">${sessionScope.user.contactinfo.street1 }</td>
		</tr>
		<tr>
			<td class="tablebody2" align="right"><b>邮编</b>：</td>
			<td class="tablebody2">${sessionScope.user.contactinfo.zip }</td>
		</tr>
		<tr>
			<td class="tablebody2" align="right"><b>家庭电话</b>：</td>
			<td class="tablebody2">${sessionScope.user.contactinfo.homephone }</td>
		</tr>
		<tr>
			<td class="tablebody2" align="right"><b>办公室电话</b>：</td>
			<td class="tablebody2">${sessionScope.user.contactinfo.officephone }</td>
		</tr>
		<tr>
			<td class="tablebody2" align="right"><b>手机</b>：</td>
			<td class="tablebody2">${sessionScope.user.contactinfo.cellphone }</td>
		</tr>
		<tr>
			<td class="tablebody2" align="right"><b>Email地址</b>：</td>
			<td class="tablebody2">${sessionScope.user.contactinfo.email }</td>
		</tr>
	</table>
<br>
<!--文件尾开始-->
		...
		<tr>
			...
			<td class=tablebody2 valign=middle width="">&nbsp;&nbsp;<a href="ProductDetailServlet?productid=${orderline.product.productid }" target="_blank">${orderline.product.name }</a></td>
			<td class=tablebody2 valign=middle align=center width="">价格：${orderline.product.baseprice }</td>
			<td class=tablebody2 valign=middle align=center width="">数量：${orderline.amount }</td>
