...
public class LifeServletTest extends HttpServlet {
	...
	public LifeServletTest() {
		System.out.println("调用LifeServletTest中的构造器");
	}
	...
	public void init() throws ServletException {
		...
		System.out.println("调用LifeServletTest中init()方法");
		
	}
	
	@Override
	public void destroy() {
		System.out.println("调用LifeServletTest中的destroy()方法");
	}
	
	protected void doGet(HttpServletRequest request, HttpServletResponse response) throws ServletException, IOException {
		//注意:tomcat在这一步直接调用的是service方法,
		//只不过是service方法中又一层层的调用,最后调用到了doGet方法
		System.out.println("调用LifeServletTest中的doGet方法");
